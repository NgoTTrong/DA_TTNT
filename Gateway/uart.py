...
class Uart:
    ...
    def process_data(self,data):
        ...
        if "temperature" in data_from_sensor:
            self.client.publish("air_conditioner", data_from_sensor['temperature'])
        elif "light" in data_from_sensor:
            self.client.publish("light_sensor", data_from_sensor['light'])
        elif "humidity" in data_from_sensor:
            self.client.publish("humidity_sensor", data_from_sensor['humidity'])
